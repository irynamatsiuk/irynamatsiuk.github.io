...
export default function createContactTab() {
    ...
    createElement("p", "Enjoy a taste of Italy, just like Nonna used to make!", "motto");
    createElement("h4", "Address:");
    createElement("p", "Calle Inexistente, 12 50023 Firenze, Italia");
    createElement("p", "(Behind the old fountain, next to the wine shop)", "comment");
    ...
    createElement("p", "(We'll save you a seat and a glass of Chianti!)", "comment");
}