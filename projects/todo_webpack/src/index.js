...
// Event Listeners
// Demo button: add demo tasks to the project selected in dropdown and shows in a task list
...
npb.addEventListener("click", () => {
  ...
  npb.textContent =
    npb.textContent == "Close Project Form"
      ? "New Project"
      : "Close Project Form";
});

//Add new project button: add new project to the projects array and show it in dropdown menu, refresh task list to new one, hide new projects input fields
...
fb.addEventListener("click", () => {
  ...
  fb.textContent =
    fb.textContent == "Close Task Form" ? "New Task" : "Close Task Form";
});
